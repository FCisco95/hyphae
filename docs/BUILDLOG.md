...
**Numbers:** 57/57 tests (30 core, 27 api) · 2 contributions scored live: 85/100 credited 85, and 3/100 credited 0 · 5.4–7.7 s per score · $0.011–$0.013 per score on Sonnet 5 · $0.024 total scoring spend · 3 migrations on Neon · 12 commits.
**Commits:** bcf5756, 48e61f9, cb4e363, 22b0875, 4b76770, a9fe52f
**Next:** rubric 1.1.0 (project context, image hint, `spam` code-only, AI-pattern list) against an evaluation set of real MYCEL replies; weekly judge video #1 (opens Fri 16:00 Lisbon); then the public score page so the reasoning is one link away.
